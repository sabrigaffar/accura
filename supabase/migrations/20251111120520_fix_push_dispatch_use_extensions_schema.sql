-- Final fix: explicitly call extensions.http_post(url text, headers jsonb, body jsonb)
-- Date: 2025-11-11

BEGIN;

-- Ensure pg_net extension exists (placed in extensions schema by Supabase)
DO $$
BEGIN
...
-- Replace function to use extensions.http_post with correct argument types
