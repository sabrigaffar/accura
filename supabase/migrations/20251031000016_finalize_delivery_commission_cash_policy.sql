-- Respect merchant_commission_apply_on_cash setting in finalize_delivery_tx
-- If payment is cash and merchant_commission_apply_on_cash = false, do not charge merchant commission
...
BEGIN
  ...
  -- merchant commission (respect cash policy)
  ...
  RETURN QUERY SELECT true, 'تم إنهاء التسليم وتسوية المستحقات والعمولات (سياسة كاش مفعّلة)'::text; RETURN;
END $$;
