-- Improve finalize_delivery_tx: fallback when no wallet hold exists and treat zero/negative distance as missing
-- Also cap per-km fee to not exceed driver delivery fee and honor driver_commission_free_until
-- Date: 2025-11-09
