-- CASH policy: do NOT credit driver's wallet with delivery fee on cash orders.
-- Only debit (capture) platform fees (service + per-km) from driver wallet.
-- ONLINE keeps deposit to driver and per-km capture.
-- Merchant settlement stays for ONLINE only to merchant user wallet.
-- Date: 2025-11-07
