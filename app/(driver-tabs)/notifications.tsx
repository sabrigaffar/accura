  ...
  const handleMarkAllAsRead = () => {
    Alert.alert(
      ...
      [
        ...
        { text: 'نعم', onPress: markAllAsRead },
      ]
    );
  };
...
const styles = StyleSheet.create({
  ...
  badge: { backgroundColor: '#EF4444', borderRadius: 12, paddingHorizontal: 8, paddingVertical: 2, minWidth: 24, alignItems: 'center' },
  badgeText: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' },
  markAllButton: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 8, backgroundColor: '#EEF2FF' },
  markAllText: { color: '#6366F1', fontSize: 14, fontWeight: '600' },
  listContent: { padding: 16 },
  emptyListContent: { flex: 1, justifyContent: 'center' },
  notificationItem: { flexDirection: 'row', backgroundColor: '#FFFFFF', borderRadius: 12, padding: 16, marginBottom: 12, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 2, elevation: 2 },
  unreadItem: { backgroundColor: '#EEF2FF', borderLeftWidth: 4, borderLeftColor: '#6366F1' },
  notificationIcon: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#F3F4F6', justifyContent: 'center', alignItems: 'center', marginRight: 12 },
  iconEmoji: { fontSize: 24 },
  notificationContent: { flex: 1 },
  notificationHeader: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 4 },
  notificationTitle: { fontSize: 16, fontWeight: '600', color: '#111827', flex: 1 },
  unreadText: { color: '#4F46E5' },
  unreadBadge: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#6366F1' },
  notificationBody: { fontSize: 14, color: '#6B7280', marginBottom: 8, lineHeight: 20 },
  notificationTime: { fontSize: 12, color: '#9CA3AF' },
  notificationActions: { justifyContent: 'center', marginLeft: 8 },
