...
export default function DriverHelp() {
  ...
  const handleEmail = () => {
    Linking.openURL('mailto:sabrigaafar@gmail.com?subject=دعم تطبيق السائق');
  };
  ...
  const faqData = [
    {
      question: 'كيف أقبل طلب توصيل؟',
      answer: 'اذهب إلى تبويب "الطلبات المتاحة" واضغط على "قبول الطلب" للطلب الذي تريده.',
    },
    {
      question: 'كيف أتتبع أرباحي؟',
      answer: 'يمكنك مشاهدة أرباحك في تبويب "أرباحي" مع إحصائيات تفصيلية يومية وشهرية.',
    },
    {
      question: 'ماذا أفعل في حالة طارئة؟',
      answer: 'يمكنك إلغاء الطلب من صفحة الطلب النشط مع إدخال سبب الإلغاء.',
    },
    {
      question: 'كيف أغير معلومات حسابي؟',
      answer: 'اذهب إلى "حسابي" ثم "معلومات الحساب" لتعديل اسمك ورقم هاتفك.',
    },
  ];
