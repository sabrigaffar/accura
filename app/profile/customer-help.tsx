...
export default function CustomerHelp() {
  ...
  const handleEmail = () => {
    Linking.openURL('mailto:sabrigaafar@gmail.com?subject=دعم تطبيق العميل');
  };
  ...
  const faqData = [
    {
      question: 'كيف أطلب من متجر؟',
      answer: 'اذهب إلى تبويب "المتاجر" واختر المتجر المطلوب، ثم أضف المنتجات للسلة وأكمل الطلب.',
    },
    {
      question: 'كيف أتتبع طلبي؟',
      answer: 'في تبويب "طلباتي" يمكنك مشاهدة جميع طلباتك وتتبع الطلب النشط بالخريطة.',
    },
    {
      question: 'كيف أضيف عنوان توصيل؟',
      answer: 'اذهب إلى "حسابي" ثم "عناويني" واضغط "إضافة عنوان جديد".',
    },
    {
      question: 'كيف أقيّم التاجر أو السائق؟',
      answer: 'بعد استلام طلبك، سيظهر لك خيار التقييم في صفحة الطلب.',
    },
  ];
