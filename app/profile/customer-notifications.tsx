...
import { ArrowLeft, Bell, Package, DollarSign, MessageSquare, Volume2, Truck } from 'lucide-react-native';
  ...
  const notificationSettings = [
    {
      icon: Package,
      title: 'حالة الطلب',
      description: 'إشعار عند تحديث حالة طلبك',
      key: 'orderStatus' as const,
    },
    {
      icon: Truck,
      title: 'التوصيل',
      description: 'إشعار عند وصول السائق',
      key: 'delivery' as const,
    },
    {
      icon: DollarSign,
      title: 'العروض والخصومات',
      description: 'إشعار عند توفر عروض جديدة',
      key: 'offers' as const,
    },
    {
      icon: MessageSquare,
